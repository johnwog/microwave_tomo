...
%     ita_d = iita_d^(-1); %D norm factor
    ...
    dt_cur_denom1 = (gt_pre(:,1:Nsources)'*Td*gt_pre(:,1:Nsources)); %auxiliary matrix that has the norms of repetition in column 1 and extra trash information
